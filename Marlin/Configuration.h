...
#define CUSTOM_MACHINE_NAME "Ender3V2_422BLTUBL_LA"
...
#define EXTRUDE_MINTEMP 180  // Customizable by menu
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41.5, -7, 0 }  // BLTouch offset for support: https://www.thingiverse.com/thing:4605354 (z-offset = -1.80 mm)

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 10  // Avoid clips on borders

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (200*60)  // increase travel speed between probes

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (16*60)  // increase probe Z speed
...
#define EXTRA_PROBING    1  // Enabled
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   10 // Z Clearance for Deploy/Stow  // Increase speed
#define Z_CLEARANCE_BETWEEN_PROBES  5 // Z Clearance between probe points  // Increase probe compatibility
#define Z_CLEARANCE_MULTI_PROBE     5 // Z Clearance between multiple probes  // Increase speed
//#define Z_AFTER_PROBING           5 // Z position after probing is done

#define Z_PROBE_LOW_POINT          -3 // Farthest distance below the trigger-point to go before stopping  // allows reach lower points
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // Enable M48 repeatability test
 ...
 */
#define PROBING_HEATERS_OFF       // Turn heaters off when probing  // Probe stability
#if ENABLED(PROBING_HEATERS_OFF)
  //#define WAIT_FOR_BED_HEATER     // Wait for bed to heat back up between probes (to improve accuracy)
  //#define WAIT_FOR_HOTEND         // Wait for hotend to heat back up between probes (to improve accuracy & prevent cold extrude)
#endif
#define PROBING_FANS_OFF          // Turn fans off when probing  // Turn fans off for avoid vibrations and interference
//#define PROBING_ESTEPPERS_OFF     // Turn all extruder steppers off when probing
//#define PROBING_STEPPERS_OFF      // Turn all steppers off (unless needed to hold position) when probing (including extruders)
#define DELAY_BEFORE_PROBING 200  // (ms) To prevent vibrations from triggering piezo sensors  // Wait for stability
...
#define HOME_AFTER_DEACTIVATE   // Require rehoming after steppers are deactivated. Also enable NO_MOTION_BEFORE_HOMING for extra safety.  // Enabled for safety
...
//#define Z_HOMING_HEIGHT  10      // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...  // Crearance over the bed
                                  // Be sure to have this much clearance over your Z_MAX_POS to prevent grinding.

//#define Z_AFTER_HOMING  5      // (mm) Height to move to after homing Z  // Crearance over the bed
...
//#define AUTO_BED_LEVELING_BILINEAR  // BLTouch auto level  // Disabled for UBL
...
#define PREHEAT_BEFORE_LEVELING  // Heatting to compensate thermal expansions
  ...
  #define LEVELING_NOZZLE_TEMP   0   // (°C) Only applies to E0 at this time  // No necessary for BLTouch
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 5  // Customizable by menu
  ...
  #define MESH_INSET 25              // Set Mesh bounds as an inset region of the bed  // Center mesh
  #define GRID_MAX_POINTS_X 5      // Don't use more than 15 points per axis, implementation limited.  // Customizable by menu
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
 ...
 */
#define Z_SAFE_HOMING  // Homing Z at center of bed
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  #define EEPROM_INIT_NOW   // Init EEPROM on first boot after a new build.  // Reset EEPROM on first boot
#endif
